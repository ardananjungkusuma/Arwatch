...
public class AppServiceProvider {
    ...
    private static ArwatchService arwatchService;

    public static ArwatchService getArwatchService() {
        if (AppServiceProvider.arwatchService == null) {
            ...
            AppServiceProvider.arwatchService = retrofit.create(ArwatchService.class);
        }

        return AppServiceProvider.arwatchService;
    }
}