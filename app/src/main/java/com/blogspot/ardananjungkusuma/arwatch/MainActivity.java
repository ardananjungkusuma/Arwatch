...
public class MainActivity extends AppCompatActivity implements WatchAdapter.OnWatchClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listWatch.add(new Watch("Casio G-Shock Mudmaster \nMaster GG-1000-1A3ER",
                "Price : £210.00 ",
        ...
        listWatch.add(new Watch("Raymond Weil Maestro \nBeatles Limited Edition",
                "Price : £796.00",
        ...
        listWatch.add(new Watch("Gucci G-Timeless Iconic \n YA1264131",
                "Price : £850.00",
        ...
        listWatch.add(new Watch("Seiko SKA791P1",
                "Price : £249.00",
                "https://d1rkccsb0jf1bk.cloudfront.net/products/100025805/main/medium/ska791p1.jpg","Gents leather analogue\nKinetic movement\nCasual / lifestyle\nGreen dial and brown strap or bracelet"));
        listWatch.add(new Watch("Emporio Armani AR11115",
                "Price : £276.00",
                "https://d1rkccsb0jf1bk.cloudfront.net/products/100022842/main/medium/AR11115_main.jpg","Official Emporio Armani presentation box\nOfficial Emporio Armani guarantee\nInstruction manual (where applicable)"));
        listWatch.add(new Watch("Seiko Gundam ","Price : £2947","https://watchesbysjx.com/wp-content/uploads/2019/04/Seiko-Mobile-Suit-Gundam-40th-Anniversary-Gundam-Limited-Edition-SBDB033J1.jpg","The flagship watch of the series – the Prospex LX Spring Drive GMT Gundam Limited Edition SBDB033J – is dedicated to the instantly recognisable titular character of the series. The tricolour red, blue and yellow livery is modelled on the RX-78-2 Gundam robot manned by the hero Amuro Ray in Mobile Suit Gundam, who is a pilot for the Earth Federation."));
        listWatch.add(new Watch("Mens Emporio Armani \nChronograph AR6066",
                "Price : £349.00",
        ...
        listWatch.add(new Watch("Daniel Wellington Petite\n 32 Cornwall DW00100215",
                "Price : £115.00",
        ...
        listWatch.add(new Watch("Ladies Daniel Wellington \nPetite 28 ",
                "Price : £105.00",
